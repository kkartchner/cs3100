 ...
 * @author feltocraig
 * <p>
 * Original from https://github.com/feltocraig/BBP-Bellard.git
 * Modifications: Changed all functions to static and removed main function. Changed multiplier on line 82 to 1e1 so
 * that only 1 digit is returned instead of 9
 */
class Bpp {
    /**
    ...
    static int getDecimal(long n) {
        ...
        return (int) (sum * 1e1); //* 1e9); // 1e9 is 9 decimal places // **Changed to only return 1 decimal.
    }
